...
%21/01/19 – Physiology’s role in ecology (pp. 1-8) \par
%28/01/19 – Key physiological processes: 
%photosynthesis, respiration, transpiration, translocation (pp. 11-203) \par
%04/02/19 – Light (pp. 26-47, 237-238) \par
%11/02/19 – Temperature (pp. 60-63, 127-129, 239-244) \par
%18/02/19 – Water (53-57, 163-217) \par
%25/02/19 – CO2 (pp. 87-90) \par
%04/03/19 – Nutrients (pp. 58-59, 225-310) \par
%11/03/19 – NO CLASSES; SPRING BREAK \par
%18/03/19 – Growth and allocation (pp. 321-367) \par
%25/03/19 – \textbf{Deliverable idea proposal presentation} \par
%01/04/19 – Life cycles, ontogeny, and phenology (pp. 375-398) \par
%08/04/19 – Competition (pp. 505-527) \par
%15/04/19 – Symbioses (pp. 522-524) \par
%22/04/19 – Decomposition (pp. 545-552) \par
%29/04/19 – Scaling from cells to canopies to ecosystems to the globe 
